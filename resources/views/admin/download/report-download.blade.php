@if($comment->count() > 0)   
    ...
    <div id="canvas-generator" class=" row" style="height: auto; padding: 0px; margin: 0px;">
        <!-- position: absolute; top: 20%; z-index: -99999999 -->

        @foreach($page as $pages)
        
            <div id="{{$pages->name}}-Box" class="col-md-8 padding-image" style=" background: #fff; background: #fff; padding: 25px 15px; border-bottom: solid 1px #d5d2d2;">
                <center>
                <canvas id="{{$pages->name}}" width="250" height="300" style=" width: 500px!important;"></canvas>
...
<div id="canvas-generator" class=" row" style="height: auto; padding: 0px; margin: 0px; ">
    ...
    @foreach($page as $pages)
        ...
        <div id="{{$pages->name}}-Box" class="col-md-8 padding-image" style=" background: #fff; padding: 25px 15px; border-bottom: solid 1px #d5d2d2;">
            <center>
